/*********************************************************************
 ...
 versao 0.49              | 27.10.2016 13:34:47
 Gera script para animação com gnuplot.
...
const char  vers_id[8]    = "v0.491";
const char  date_id[16]   = "31/10/2016";
...
#include "bts-vars-0.491.h"                         // parametros/variaveis
#include "bts-util-0.491.h"                         // bibliotecas
...
//  ---------------------------------------------------------------------
int main () {
  int         ind, loop, i, timex0, ext_tumor;
  ...
  for (i = 0; i < nz; i++){
    y[2] = dequant(i, 0, nz, z_min, z_max);
    fprintf(a,"\n\n# z = %5.2f\n", y[2]);
    printf("z = %6.2f i = %d \n", y[2], i);                                  // print na tela, controle!
